...
APP_ERROR_STATUS_CODES: dict[AppErrorCode, int] = {
    ...
    AppErrorCode.CATEGORY_WITH_NAME_ALREADY_EXIST: status.HTTP_409_CONFLICT,
    AppErrorCode.CATEGORY_HAS_PRODUCTS: status.HTTP_409_CONFLICT,
    AppErrorCode.ORDER_NOT_FOUND: status.HTTP_404_NOT_FOUND,
    AppErrorCode.PAYMENT_NOT_FOUND: status.HTTP_404_NOT_FOUND,
...
DOMAIN_ERROR_STATUS_CODES: dict[DomainErrorCode, int] = {
    ...
    DomainErrorCode.INVALID_PAYMENT_STATUS_TRANSITION: status.HTTP_409_CONFLICT,
}
